...
def _build_audit(_source_hash: str):
    """Legacy index + reconciliation + component contributions + forward-fill
    audit, cached per data version. Keyed on the DATA.xlsx content hash."""
    df_local = load_data()
...
audit_bundle = _build_audit(source_signature())
